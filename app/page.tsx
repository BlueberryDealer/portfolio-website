      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.3fr 1fr", gap: "1.25rem", alignItems: "stretch" }}>
        <div style={{ ...glass, minHeight: 500, display: "flex", alignItems: "center" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: "1.75rem", color: C.textMuted, fontSize: 15, lineHeight: 2 }}>
            <p>I&apos;m a Fintech student at <span style={{ color: C.text, fontWeight: 600 }}>Singapore Institute of Technology</span> with a passion for building full-stack web applications and solving algorithmic problems.</p>
            <p>I enjoy working across the entire stack — from designing <span style={{ color: C.text, fontWeight: 600 }}>clean user interfaces</span> to architecting <span style={{ color: C.text, fontWeight: 600 }}>backend systems</span> with proper design patterns.</p>
            <p>When I&apos;m not coding, you can find me exploring new technologies, contributing to group projects, or levelling up my DSA skills.</p>
          </div>
        </div>
